...
/**
 * Represents an instance of `DataScannerSmsValue`, backed by a C++ struct.
 */
public typealias DataScannerSmsValue = margelo.nitro.datascanner.DataScannerSmsValue

public extension DataScannerSmsValue {
  private typealias bridge = margelo.nitro.datascanner.bridge.swift

  /**
   * Create a new instance of `DataScannerSmsValue`.
   */
