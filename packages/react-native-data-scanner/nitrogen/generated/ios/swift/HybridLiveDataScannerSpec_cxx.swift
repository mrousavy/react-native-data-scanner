///
/// HybridLiveDataScannerSpec_cxx.swift
...
/**
 * A class implementation that bridges HybridLiveDataScannerSpec over to C++.
 ...
 */
open class HybridLiveDataScannerSpec_cxx {
  /**
  ...
  /**
   * Holds an instance of the `HybridLiveDataScannerSpec` Swift protocol.
   */
  private var __implementation: any HybridLiveDataScannerSpec

  /**
   * Holds a weak pointer to the C++ class that wraps the Swift class.
   */
  private var __cxxPart: bridge.std__weak_ptr_HybridLiveDataScannerSpec_

  /**
   * Create a new `HybridLiveDataScannerSpec_cxx` that wraps the given `HybridLiveDataScannerSpec`.
   * All properties and methods bridge to C++ types.
   */
  public init(_ implementation: any HybridLiveDataScannerSpec) {
  ...
  /**
   * Get the actual `HybridLiveDataScannerSpec` instance this class wraps.
   */
  @inline(__always)
  public func getHybridLiveDataScannerSpec() -> any HybridLiveDataScannerSpec {
  ...
  /**
   * Casts an unsafe pointer to a `HybridLiveDataScannerSpec_cxx`.
   * The pointer has to be a retained opaque `Unmanaged<HybridLiveDataScannerSpec_cxx>`.
   * This removes one strong reference from the object!
   */
  public class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridLiveDataScannerSpec_cxx {
    return Unmanaged<HybridLiveDataScannerSpec_cxx>.fromOpaque(pointer).takeRetainedValue()
  }

  /**
   * Gets (or creates) the C++ part of this Hybrid Object.
   * The C++ part is a `std::shared_ptr<HybridLiveDataScannerSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_HybridLiveDataScannerSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_HybridLiveDataScannerSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_HybridLiveDataScannerSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridLiveDataScannerSpec_cxx) -> Bool {
