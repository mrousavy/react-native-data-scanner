...
namespace margelo::nitro::datascanner {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/datascanner/Bounds;";
  ...
  public:
    ...
    static jni::local_ref<JBounds::javaobject> fromCpp(const Bounds& value) {
      using JSignature = JBounds(jni::alias_ref<JPoint>, jni::alias_ref<JPoint>, jni::alias_ref<JPoint>, jni::alias_ref<JPoint>);
      static const auto clazz = javaClassStatic();
