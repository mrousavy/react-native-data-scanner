...
/**
 * Represents the JavaScript object/struct "Quadrilateral".
 */
@DoNotStrip
@Keep
data class Quadrilateral(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is Quadrilateral) return false
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(topLeft: Point, topRight: Point, bottomRight: Point, bottomLeft: Point): Quadrilateral {
