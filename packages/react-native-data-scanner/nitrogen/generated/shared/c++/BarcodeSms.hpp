...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BarcodeSms).
   */
  struct BarcodeSms final {
  public:
  ...
  public:
    BarcodeSms() = default;
    explicit BarcodeSms(std::optional<std::string> phoneNumber, std::optional<std::string> message): phoneNumber(phoneNumber), message(message) {}

  public:
    friend bool operator==(const BarcodeSms& lhs, const BarcodeSms& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ BarcodeSms <> JS BarcodeSms (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::BarcodeSms> final {
    static inline margelo::nitro::datascanner::BarcodeSms fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::BarcodeSms(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::BarcodeSms& arg) {
