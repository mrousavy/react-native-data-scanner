...
namespace margelo::nitro::datascanner {
  ...
  public:
    ...
    explicit CapturedPhoto(std::string uri, double width, double height): uri(uri), width(width), height(height) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::datascanner::CapturedPhoto> final {
    static inline margelo::nitro::datascanner::CapturedPhoto fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::CapturedPhoto(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::CapturedPhoto& arg) {
