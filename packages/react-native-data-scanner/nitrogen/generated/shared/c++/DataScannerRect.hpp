...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DataScannerRect).
   */
  struct DataScannerRect final {
  public:
  ...
  public:
    DataScannerRect() = default;
    explicit DataScannerRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const DataScannerRect& lhs, const DataScannerRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DataScannerRect <> JS DataScannerRect (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::DataScannerRect> final {
    static inline margelo::nitro::datascanner::DataScannerRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::DataScannerRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::DataScannerRect& arg) {
