...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::datascanner::Point> final {
    static inline margelo::nitro::datascanner::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::Point& arg) {
