...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DataScannerGeoValue).
   */
  struct DataScannerGeoValue final {
  public:
    double latitude     SWIFT_PRIVATE;
    double longitude     SWIFT_PRIVATE;

  public:
    DataScannerGeoValue() = default;
    explicit DataScannerGeoValue(double latitude, double longitude): latitude(latitude), longitude(longitude) {}

  public:
    friend bool operator==(const DataScannerGeoValue& lhs, const DataScannerGeoValue& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DataScannerGeoValue <> JS DataScannerGeoValue (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::DataScannerGeoValue> final {
    static inline margelo::nitro::datascanner::DataScannerGeoValue fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::DataScannerGeoValue(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::DataScannerGeoValue& arg) {
