...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DataScannerUrlValue).
   */
  struct DataScannerUrlValue final {
  public:
    std::optional<std::string> title     SWIFT_PRIVATE;
    std::optional<std::string> url     SWIFT_PRIVATE;

  public:
    DataScannerUrlValue() = default;
    explicit DataScannerUrlValue(std::optional<std::string> title, std::optional<std::string> url): title(title), url(url) {}

  public:
    friend bool operator==(const DataScannerUrlValue& lhs, const DataScannerUrlValue& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DataScannerUrlValue <> JS DataScannerUrlValue (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::DataScannerUrlValue> final {
    static inline margelo::nitro::datascanner::DataScannerUrlValue fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::DataScannerUrlValue(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::DataScannerUrlValue& arg) {
