...
namespace margelo::nitro::datascanner {
  ...
  enum class DataScannerUnavailableReason {
    UNSUPPORTED_DEVICE      SWIFT_NAME(unsupportedDevice) = 0,
    CAMERA_PERMISSION_DENIED      SWIFT_NAME(cameraPermissionDenied) = 1,
    CAMERA_RESTRICTED      SWIFT_NAME(cameraRestricted) = 2,
    CAMERA_UNAVAILABLE      SWIFT_NAME(cameraUnavailable) = 3,
    SCANNER_MODULE_UNAVAILABLE      SWIFT_NAME(scannerModuleUnavailable) = 4,
  ...
  struct JSIConverter<margelo::nitro::datascanner::DataScannerUnavailableReason> final {
    static inline margelo::nitro::datascanner::DataScannerUnavailableReason fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        case hashString("unsupported-device"): return margelo::nitro::datascanner::DataScannerUnavailableReason::UNSUPPORTED_DEVICE;
        ...
        case hashString("scanner-module-unavailable"): return margelo::nitro::datascanner::DataScannerUnavailableReason::SCANNER_MODULE_UNAVAILABLE;
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, margelo::nitro::datascanner::DataScannerUnavailableReason arg) {
      switch (arg) {
        case margelo::nitro::datascanner::DataScannerUnavailableReason::UNSUPPORTED_DEVICE: return JSIConverter<std::string>::toJSI(runtime, "unsupported-device");
        ...
        case margelo::nitro::datascanner::DataScannerUnavailableReason::SCANNER_MODULE_UNAVAILABLE: return JSIConverter<std::string>::toJSI(runtime, "scanner-module-unavailable");
