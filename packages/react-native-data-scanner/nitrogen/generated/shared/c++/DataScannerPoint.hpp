...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DataScannerPoint).
   */
  struct DataScannerPoint final {
  public:
    double x     SWIFT_PRIVATE;
    double y     SWIFT_PRIVATE;

  public:
    DataScannerPoint() = default;
    explicit DataScannerPoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const DataScannerPoint& lhs, const DataScannerPoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DataScannerPoint <> JS DataScannerPoint (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::DataScannerPoint> final {
    static inline margelo::nitro::datascanner::DataScannerPoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::DataScannerPoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::DataScannerPoint& arg) {
