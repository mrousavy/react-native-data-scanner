...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::datascanner::Rect> final {
    static inline margelo::nitro::datascanner::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::Rect& arg) {
