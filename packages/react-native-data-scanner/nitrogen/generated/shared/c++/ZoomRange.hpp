...
namespace margelo::nitro::datascanner {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ZoomRange).
   */
  struct ZoomRange final {
  public:
  ...
  public:
    ZoomRange() = default;
    explicit ZoomRange(double min, double max): min(min), max(max) {}

  public:
    friend bool operator==(const ZoomRange& lhs, const ZoomRange& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ZoomRange <> JS ZoomRange (object)
  template <>
  struct JSIConverter<margelo::nitro::datascanner::ZoomRange> final {
    static inline margelo::nitro::datascanner::ZoomRange fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::datascanner::ZoomRange(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::datascanner::ZoomRange& arg) {
